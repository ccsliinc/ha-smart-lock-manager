...
[![Version](https://img.shields.io/badge/Version-2026.6.1-green.svg)](#)
...
```bash
wget https://github.com/ccsliinc/ha-smart-lock-manager/archive/refs/tags/v2026.6.1.zip
unzip v2026.6.1.zip
cp -r ha-smart-lock-manager-2026.6.1/custom_components/smart_lock_manager /config/custom_components/
```
